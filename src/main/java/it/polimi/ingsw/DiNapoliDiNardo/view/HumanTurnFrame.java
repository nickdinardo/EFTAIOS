...
public class HumanTurnFrame extends TurnFrame{
	...
	private static final Color humancolor = Color.getHSBColor(140, 217, 207);
	...
	public HumanTurnFrame(String name, String actualPosition, String turn, List<String> objects){
		...
		comunication.setForeground(humancolor);
		...
		positionLabel.setForeground(humancolor);
		nameLabel = new JLabel(name);
		nameLabel.setFont(f2);
		nameLabel.setForeground(humancolor);
		turnLabel = new JLabel("Turn: " + turn);
		turnLabel.setFont(f1);
		turnLabel.setForeground(humancolor);
		...
		descCard1.setForeground(humancolor);
		...
		descCard2.setForeground(humancolor);
		...
		descCard3.setForeground(humancolor);
		...
		nextButton.setForeground(humancolor);
