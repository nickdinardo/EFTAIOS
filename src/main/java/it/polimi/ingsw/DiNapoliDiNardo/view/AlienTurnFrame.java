...
public class AlienTurnFrame extends TurnFrame {
	...
	public AlienTurnFrame(String name, String actualPosition, String turn, List<String> objects){
		...
		case 1:
			if(item.get(0) == ""){
				...
				JLabel card1 = new JLabel(new ImageIcon("C:\\Users\\Beckham\\Nick\\Documenti\\Polimi\\E.F.T.A.I.O.S\\ItemCard\\" + item.get(1) + ".png"));
		...
		case 2:
			JLabel card1 = new JLabel(new ImageIcon("C:\\Users\\Beckham\\Nick\\Documenti\\Polimi\\E.F.T.A.I.O.S\\ItemCard\\" + item.get(0) + ".png"));
			card1.setToolTipText(itemDescription[0].getTipText());
			JLabel descCard1 = new JLabel(item.get(0));
			descCard1.setForeground(Color.green);
			descCard1.setFont(f1);
			...
			panel1.add(descCard1, BorderLayout.SOUTH);
			panel.add(panel1);
			JLabel card2 = new JLabel(new ImageIcon("C:\\Users\\Beckham\\Nick\\Documenti\\Polimi\\E.F.T.A.I.O.S\\ItemCard\\" + item.get(1) + ".png"));
		...
		case 3:
			...
			panel2.add(descCard2, BorderLayout.SOUTH);
			panel.add(panel2);
			JLabel card3 = new JLabel(new ImageIcon("C:\\Users\\Beckham\\Nick\\Documenti\\Polimi\\E.F.T.A.I.O.S\\ItemCard\\" + item.get(2) + ".png"));
		...
		JScrollBar jsb = panel4.getVerticalScrollBar();
	...
	public TurnFrame update(String name, String position, String turn, List<String> objects) {
		TurnFrame frame = new AlienTurnFrame(name, position, turn, objects);
		return frame;
