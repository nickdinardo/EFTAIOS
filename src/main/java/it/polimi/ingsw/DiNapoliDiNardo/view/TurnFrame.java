...
public abstract class TurnFrame {
	...
	/*public abstract boolean getWaitForItem();
	public abstract int getIndexCard();*/
	...
	protected JToolTip[] setToolTip(List<String> objects){
		switch(objects.size()){
		case 1:
			if(objects.get(0) == ""){
	...
	protected JToolTip specifiedTip(String object){
